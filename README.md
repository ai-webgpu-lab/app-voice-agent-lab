...
- Repo-specific Pages baseline copied from `repo-scaffolds/repos/app-voice-agent-lab/`
...
## 현재 baseline 상태
- Repository-specific runnable baseline active: integrated voice agent lab demo with deterministic wake word, transcript, task routing, and app-level result export
- Generated override source: `repo-scaffolds/repos/app-voice-agent-lab/`
...
- 이 저장소의 live demo는 `https://ai-webgpu-lab.github.io/app-voice-agent-lab/`입니다.
